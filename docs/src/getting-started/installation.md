...
| Platform       | Download                                                                                    |
| -------------- | ------------------------------------------------------------------------------------------- |
| Linux x86-64   | [autogpt](https://github.com/wiseaidotdev/autogpt/releases/download/v0.3.5/autogpt)         |
| Windows x86-64 | [autogpt.exe](https://github.com/wiseaidotdev/autogpt/releases/download/v0.3.5/autogpt.exe) |
