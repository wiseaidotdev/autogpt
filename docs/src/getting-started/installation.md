...
| Platform       | Download                                                                                    |
| -------------- | ------------------------------------------------------------------------------------------- |
| Linux x86-64   | [autogpt](https://github.com/wiseaidotdev/autogpt/releases/download/v0.4.0/autogpt)         |
| Windows x86-64 | [autogpt.exe](https://github.com/wiseaidotdev/autogpt/releases/download/v0.4.0/autogpt.exe) |
