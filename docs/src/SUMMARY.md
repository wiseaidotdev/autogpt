...
- [Interactive Mode](./modes/interactive.md)
- [Direct Prompt Mode](./modes/direct-prompt.md)
- [Standalone Mode](./modes/standalone.md)
- [Orchestrated Mode](./modes/orchestrated.md)
...
- [FrontendGPT](./agents/frontend-gpt.md)
- [DesignerGPT](./agents/designer-gpt.md)
- [GitGPT](./agents/git-gpt.md)
- [MailerGPT](./agents/mailer-gpt.md)
- [OptimizerGPT](./agents/optimizer-gpt.md)

# SDK & Custom Agents

- [SDK Overview](./sdk/overview.md)
- [AutoGPT Builder](./sdk/autogpt-builder.md)
- [Creating Custom Agents](./sdk/custom-agents.md)
- [Traits Reference](./sdk/traits.md)
- [The `agents!` Macro](./sdk/macros.md)
