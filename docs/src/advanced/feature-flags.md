...
```toml
autogpt = { version = "0.3.5", features = ["gem", "gpt", "cli"] }
```
...
```toml
autogpt = { version = "0.3.5", features = ["gem", "gpt", "net", "cli"] }
```

**Everything:**

```toml
autogpt = { version = "0.3.5", features = ["gem", "gpt", "img", "git", "mail", "mem", "net", "cli"] }
```
