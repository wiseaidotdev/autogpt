...
```toml
autogpt = { version = "0.4.0", features = ["gem", "gpt", "cli"] }
```

**SDK with memory:**

```toml
autogpt = { version = "0.4.0", features = ["gem", "gpt", "mem"] }
```

**Networked orchestrated mode:**

```toml
autogpt = { version = "0.4.0", features = ["gem", "gpt", "net", "cli"] }
```

**Everything:**

```toml
autogpt = { version = "0.4.0", features = ["gem", "gpt", "img", "git", "mail", "mem", "net", "cli"] }
```
