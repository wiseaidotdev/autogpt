...
|         Method 1: [Download Executable File](https://github.com/wiseaidotdev/autogpt/releases/download/v0.2.5/autogpt)         |              [Download `.exe` File](https://github.com/wiseaidotdev/autogpt/releases/download/v0.2.5/autogpt.exe)              |                                                          -                                                           |                                                          -                                                           |
...
|                                                 `autogpt -h` <br> `orchgpt -h`                                                 |                                                        `autogpt.exe -h`                                                        |                                       `docker run kevinrsdev/autogpt:0.2.5 -h`                                       |                                       `docker run kevinrsdev/orchgpt:0.2.5 -h`                                       |
